...
export default function Home() {
  ...
  // Fallback data just in case API is not returning the specified packages yet
      ...
      <header className="sticky top-0 z-50 w-full border-b bg-white/80 backdrop-blur-md">
        <div className="container mx-auto px-4 h-16 flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <span className="font-bold text-xl tracking-tight">NetForfait Gabon</span>
          </div>
        </div>
      </header>
      ...
      <section className="pt-16 pb-12 md:pt-24 md:pb-20 px-4 text-center">
        <div className="container mx-auto max-w-3xl">
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-extrabold tracking-tight text-foreground mb-6">
            Rechargez votre forfait internet en <span className="text-primary">quelques secondes</span>
          </h1>
      ...
      <footer className="mt-auto border-t bg-white py-12 px-4">
        <div className="container mx-auto max-w-5xl flex flex-col md:flex-row items-center justify-between gap-6">
          <div className="flex items-center gap-2">
            ...
            <span className="font-bold text-lg">NetForfait Gabon</span>
          </div>
